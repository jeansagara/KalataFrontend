...
export class AuthService {
  ...
  inscription(username: string,biometrie:string,datenaissance:any,telephone:string,sexe:string,email:string,password: string,): Observable<any> {
    let data = new FormData();

    // let dateString = new Intl.DateTimeFormat("fr-FR", {
    //   day: "2-digit",
    //   month: "2-digit",
    //   year: "numeric"
    // }).format(datenaissance);

    // alert("je suis date: " + datenaissance);
    // alert("je suis l email: " + email);
    // alert("je suis username: " + username);
